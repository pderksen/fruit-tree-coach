...
const TASK_COLUMNS =
  "id, tree_id, title, why, created_at, due_date, category, description, template_id, window_start_month, window_start_day, window_end_month, window_end_day, trees!inner(name, type), task_completions(completed_at, outcome)";
